...
import { clearHubConnection, setHubConnection } from "../../redux/features/SignalRConnection/HubConnectionSlice";
...
const Home: FC = () => {
  ...
  // const LogOut = () => {
  //   if (user.connectionId != null && hubConnection) {

  //     dispatch(LogOutAsync(user.connectionId))
  ...
  useEffect(() => {
    ...
    if (isAuth == false) {
        UseNavigate("/")
        //hubConnection?.invoke("SetUserOffline",user.connectionId)
        console.log(user) 
